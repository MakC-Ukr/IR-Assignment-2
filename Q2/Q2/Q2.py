...
# able to change training-testing split to any percentage : gives best result
...
def test(X_train, y_train, X_test, y_test, tf, icf, category_wordcount):
    ...
    category_predict = []
    for doc in X_test:
        json.dump(doc.split(), open("D:\\IR\\Q2\\testdata.json", "a"))
...
if __name__ == "__main__":
    ...
    json.dump(tf, open("D:\\IR\\Q2\\tf.json", "w"))
    json.dump(icf, open("D:\\IR\\Q2\\icf.json", "w"))
